...
public class Payslip  {
	...
	public String toString() {
		return "Payslip [payslipId=" + payslipId + ", employeeCode="
				+ employeeCode + ", month=" + month + ", basic=" + basic
				+ ", hra=" + hra + ", commutationAllowance="
				+ commutationAllowance + ", lta=" + lta + ", performancePay="
				+ performancePay + ", upkeepPay=" + upkeepPay + "]";
	}
